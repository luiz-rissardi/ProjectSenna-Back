...
describe("User Service => Unit tests", () => {
    ...
    it("Deve criar um usuário com sucesso", async () => {
        ...
        const user = { userName: "Emilio Rodolfo", userDescription: "sou programador sou e engenheiro de software", email: "emilioRufolfoFey@gmail.com", language: "pt-br", password: "Luiz2006@" }
    ...
    it("Não deve criar usuário com email já existente", async () => {
        const user = { userName: "Emilio Rodolfo", userDescription: "sou programador sou e engenheiro de software", email: "emilioRufolfoFey@gmail.com", arrayBuffer: null, language: "pt-br", password: "Luiz2006@" }
